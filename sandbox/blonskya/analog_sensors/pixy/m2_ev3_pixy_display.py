...
Authors: David Fisher and Andrew Blonsky.  February 2017.
...
def main():
    ...
    while not robot.touch_sensor.is_pressed:
        ...
        exval = robot.pixy.value(1)
        whyval = robot.pixy.value(2)
        widthval = robot.pixy.value(3)
        heightval = robot.pixy.value(4)
        print("x = ", exval)
        print("y = ", whyval)
        ...
        mqtt_client.send_message('on_rectangle_update', [exval, whyval, widthval, heightval])
        time.sleep(0.25)
